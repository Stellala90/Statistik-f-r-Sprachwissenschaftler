# Hausaufgabe 05
# Stella Breunig <Breunigs@students.uni-marburg.de>
# 2014-05-04
...
# Der Median der Gruppen M.A. Germanistische Sprachwissenschaft ermöglicht keinerlei Interpretation,
# da nur eine Frau diese Gruppe vertritt und ihre Größe somit den Median festlegt. Genauso wenig 
# aussagekräftig ist der Median der Gruppe other, da diese nur aus zwei Frauen besteht und der Median
# somit direkt in der Mitte zwischen deren beiden Größen liegt. In der Speech Science Gruppe gibt es
# eine Ausreißerin mit einer Größe von 175 cm. Auf den ersten Blick scheinen die Studentinnen der 
# Gruppe Linguistik, Kognition und Kommunikation am größten zu sein, die größten Streuungen treten 
# jedoch bei den Klinischen Linguistinnen und other auf.
...
# sich die Gruppen?
# (Keine explizite Antwort nötig, nur eine Überlegung.)
# Es lassen sich Ähnlichkeiten zur Box-Whisker-Darstellung erkennen, jedoch erscheinen
# die Ergebnisse weniger deutlich in dieser Darstellung. So nimmt z.B. der Ausreißer hier
# einen viel größere Einfluss auf die Abbuldung ein.

# Welche Gruppe hat gefehlt? Wie viele Datenpunkte gab es für die Gruppe?
# (Keine explizite Antwort nötig, nur eine Überlegung.)
# Es haben die Gruppe M.A. Germanistische Linguistik (1 Person) und other (2 Personen) gefehlt.
