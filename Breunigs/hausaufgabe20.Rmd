...
ggplot(stimmen) + geom_boxplot(aes(x=subject,y=frequency)) + facet_wrap(~ gender)
...
```{r}
model.attitude.int <- lmer(frequency ~ gender*attitude + (1|subject) + (1|scenario), data=stimmen, RMEL=FALSE)
